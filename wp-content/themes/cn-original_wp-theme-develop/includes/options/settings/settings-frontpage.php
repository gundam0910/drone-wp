<?php
	...
	function themezee_settings_frontpage() {
		...
		### FRONTPAGE Image
		#######################################################################################
		$themezee_settings[] = array("name" => "Frontpage Image Source",
						"desc" => __('Choose which image(s) the frontpage template should display.', 'zeeTasty_lang'),
						"id" => "themeZee_frontpage_image_source",
						"std" => "header",
						"type" => "radio",
						'choices' => array(
									'header' => 'Custom Header Image (from Appearance > Header)',
									'upload' => 'Individual Image uploaded below'),
						"section" => "themeZee_frontpage_image"
						);
		
		$themezee_settings[] = array("name" => "Frontpage Image",
